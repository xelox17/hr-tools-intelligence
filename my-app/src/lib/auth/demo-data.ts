/**
 * Types and non-sensitive sample content used by the demo pages (Team,
 * Payroll, Recruitment, Policies). The Team/Payroll/Recruitment records
 * themselves come from the API (/api/team, /api/payroll, /api/recruitment);
 * only their shared shapes and the policy documents live here.
 */
...
// ------------------------------------------------------------------- policies
// Policies are readable by every role, so they ship with the page.
