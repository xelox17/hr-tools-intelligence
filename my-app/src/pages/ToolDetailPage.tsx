...
import { getSimilarTools, getToolById } from "@/lib/analytics";
  ...
  if (!tool) {
    return (
      <div className="flex flex-col items-center gap-3 py-16 text-center">
        <p className="font-heading text-lg font-semibold text-foreground">Tool not found</p>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-2">
              <Badge variant={tool.scope === "Corporate" ? "default" : "secondary"}>{tool.scope}</Badge>
              <Badge variant="outline">{tool.category}</Badge>
            </div>
          </div>
        </div>

        <a href={tool.url} target="_blank" rel="noopener noreferrer" className={cn(buttonVariants({ size: "lg" }), "gap-2")}>
          Open official site
          ...
          <CardContent className="flex flex-col gap-4 text-sm">
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div className="flex flex-col">
                ...
                <a href={tool.url} target="_blank" rel="noopener noreferrer" className="font-medium break-all text-accent link-underline">
