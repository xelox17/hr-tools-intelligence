...
// Removed vs. the Next.js Home page: the "Tools by category" / "Corporate vs
// Local" / "Top countries" charts (recharts). The catalog page still lets
// you filter and export the same data — see /catalog.
const QUICK_ACCESS = [
  {
    href: "/dashboard",
    title: "Dashboard opérationnel",
    description: "Votre vue par rôle : équipe, recrutement, paie ou approbations.",
  ...
  },
  {
    href: "/policies",
    title: "Politiques RH",
    description: "Congés, télétravail, conduite et autres politiques.",
    icon: Sparkles,
  },
];
